...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "NextCode failed to load",
  "desktop.recovery.terminated": "NextCode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "NextCode is not responding",
  ...
  "desktop.wsl.error.installOpencode":
    "NextCode CLI cannot be installed automatically. Install the NextCode CLI manually in this WSL distro and retry.",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NextCode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
