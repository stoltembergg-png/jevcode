export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af NextCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i NextCode.",
  ...
  "dialog.server.description": "Skift hvilken NextCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker NextCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer NextCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater NextCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før NextCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "NextCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter NextCode igen.",
  ...
  "toast.update.description": "En ny version af NextCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til NextCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, NextCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "NextCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør NextCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for NextCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan NextCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om NextCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas NextCodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når NextCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af NextCode.",
  ...
  "desktop.recovery.loadFailed": "NextCode kunne ikke indlæses",
  "desktop.recovery.terminated": "NextCode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af NextCode mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af NextCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "NextCode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
