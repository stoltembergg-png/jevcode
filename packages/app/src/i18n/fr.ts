...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "Documentation d'NextCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'NextCode",
  "desktop.recovery.terminated": "La fenêtre NextCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "NextCode ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'NextCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'NextCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par NextCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans NextCode.",
  ...
  "dialog.server.description": "Changez le serveur NextCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'NextCode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'NextCode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour NextCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez NextCode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'NextCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "NextCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'NextCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe NextCode",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'NextCode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "NextCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur NextCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour NextCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'NextCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si NextCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'NextCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'NextCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'NextCode.",
