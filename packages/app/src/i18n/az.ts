...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.recovery.loadFailed": "NextCode yüklənə bilmədi",
  "desktop.recovery.terminated": "NextCode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "NextCode cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "NextCode quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "NextCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "NextCode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və NextCode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və NextCode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və NextCode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu NextCode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "NextCode yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də NextCode yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "NextCode yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də NextCode yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də NextCode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "NextCode-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "NextCode {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "NextCode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "NextCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "NextCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NextCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "NextCode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra NextCode-u yenidən açın.",
  ...
  "help.tabs.introduction": "NextCode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NextCode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı NextCode komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: NextCode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "NextCode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində NextCode serverini işlət.",
  ...
  "settings.general.row.language.description": "NextCode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "NextCode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "NextCode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "NextCode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "NextCode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "NextCode-un ən son versiyasından istifadə edirsiniz.",
