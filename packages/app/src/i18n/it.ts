...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da NextCode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in NextCode.",
  ...
  "dialog.server.description": "Cambia il server NextCode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo NextCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento NextCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna NextCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa NextCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che NextCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "NextCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di NextCode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team NextCode",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: NextCode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "NextCode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server NextCode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per NextCode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di NextCode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se NextCode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di NextCode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di NextCode",
  ...
  "settings.updates.toast.latest.title": "NextCode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di NextCode.",
  ...
  "desktop.menu.documentation": "Documentazione di NextCode",
  ...
  "desktop.menu.ariaLabel": "Menu NextCode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare NextCode",
  "desktop.recovery.terminated": "La finestra di NextCode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "NextCode non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di NextCode non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di NextCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
