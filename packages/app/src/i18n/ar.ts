...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.recovery.loadFailed": "فشل تحميل NextCode",
  "desktop.recovery.terminated": "توقفت نافذة NextCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "NextCode لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت NextCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث NextCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من NextCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك NextCode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في NextCode.",
  ...
  "dialog.server.description": "تبديل خادم NextCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من NextCode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث NextCode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث NextCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت NextCode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن NextCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على NextCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح NextCode.",
  ...
  "help.tabs.introduction": "أصبح NextCode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من NextCode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق NextCode",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن NextCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن NextCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم NextCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ NextCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور NextCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان NextCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة NextCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل NextCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من NextCode.",
