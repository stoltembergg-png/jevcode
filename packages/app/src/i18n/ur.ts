...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "NextCode دستاویزات",
  ...
  "desktop.menu.ariaLabel": "NextCode مینو",
  ...
  "desktop.recovery.loadFailed": "NextCode لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "NextCode ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "NextCode جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "NextCode کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں NextCode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "NextCode کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "NextCode کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور NextCode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور NextCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور NextCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس NextCode سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "NextCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں NextCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "NextCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں NextCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں NextCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "NextCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "NextCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "NextCode تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں NextCode انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "NextCode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ NextCode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "NextCode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر NextCode کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "NextCode Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NextCode ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم NextCode ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، NextCode ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "NextCode میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "NextCode ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر NextCode سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "NextCode کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر NextCode کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا NextCode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "NextCode کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "NextCode لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ NextCode کا تازہ ترین ورژن چلا رہے ہیں۔",
