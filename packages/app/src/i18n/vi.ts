...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "Tài liệu NextCode",
  ...
  "desktop.recovery.loadFailed": "Không tải được NextCode",
  "desktop.recovery.terminated": "Cửa sổ NextCode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "NextCode không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được NextCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật NextCode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do NextCode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong NextCode.",
  ...
  "dialog.server.description": "Chuyển máy chủ NextCode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra NextCode trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật NextCode trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật NextCode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt NextCode trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi NextCode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "NextCode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của NextCode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm NextCode",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: NextCode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "NextCode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ NextCode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho NextCode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của NextCode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem NextCode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của NextCode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi NextCode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của NextCode.",
