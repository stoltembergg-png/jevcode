export const dict = {
  ...
  "desktop.menu.documentation": "NextCode Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "NextCode մենյու",
  ...
  "desktop.recovery.loadFailed": "NextCode չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "NextCode պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "NextCode-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "NextCode տեղադրումը ձախողվեց",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NextCode թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են NextCode",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և NextCode-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և NextCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և NextCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ NextCode սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է NextCode-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է NextCode-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել NextCode-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "NextCode պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք NextCode-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի NextCode-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "NextCode-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք NextCode։",
  ...
  "help.tabs.introduction": "NextCode Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NextCode-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին NextCode թիմին",
  ...
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ NextCode-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "NextCode ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք NextCode սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն NextCode",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է NextCode տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ NextCode-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է NextCode-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ NextCode-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք NextCode-ի վերջին տարբերակը։",
