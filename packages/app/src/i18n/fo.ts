...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "NextCode Skjøl",
  ...
  "desktop.menu.ariaLabel": "NextCode valmynd",
  ...
  "desktop.recovery.loadFailed": "NextCode miseydnaðist at heinta",
  "desktop.recovery.terminated": "NextCode vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "NextCode svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "NextCode uppsetingin miseydnaðist",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NextCode dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av NextCode",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í NextCode.",
  ...
  "dialog.server.description": "Skift hvønn NextCode ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna NextCode í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring NextCode í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør NextCode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set NextCode upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn NextCode kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "NextCode kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani NextCode aftur.",
  ...
  "help.tabs.introduction": "NextCode Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av NextCode ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til NextCode toymið",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, NextCode stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "NextCode inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "NextCode Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr NextCode ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri NextCode",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu NextCode sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um NextCode fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu NextCode er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá NextCode byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av NextCode.",
