export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "NextCoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja NextCodessa.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja NextCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja NextCodessa.",
  ...
  "dialog.server.description": "Vaihda NextCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan NextCodea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan NextCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään NextCodea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään NextCodea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä NextCode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna NextCode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin NextCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "NextCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten NextCode uudelleen.",
  ...
  "toast.update.description": "NextCoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä NextCode-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että NextCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "NextCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita NextCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda NextCoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä NextCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö NextCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta NextCoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun NextCode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät NextCoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "NextCode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "NextCode-valikko",
  ...
  "desktop.recovery.loadFailed": "NextCoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "NextCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "NextCode ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "NextCoden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NextCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "NextCode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
