export const dict = {
  ...
  "desktop.menu.documentation": "NextCode-documentatie",
  ...
  "desktop.recovery.loadFailed": "NextCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het NextCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "NextCode reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van NextCode is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De NextCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door NextCode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in NextCode te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in NextCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in NextCode te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke NextCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "NextCode controleren...",
  "wsl.onboarding.checkingOpencodeIn": "NextCode controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "NextCode bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "NextCode bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk NextCode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "NextCode bijwerken",
  "wsl.onboarding.opencodeReadyIn": "NextCode is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer NextCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat NextCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "NextCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens NextCode opnieuw.",
  ...
  "help.tabs.introduction": "NextCode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van NextCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het NextCode-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: NextCode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "NextCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de NextCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor NextCode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe NextCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of NextCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van NextCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer NextCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "NextCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van NextCode.",
