...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.recovery.loadFailed": "NextCode kunde inte läsas in",
  "desktop.recovery.terminated": "NextCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "NextCode svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av NextCode misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NextCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av NextCode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i NextCode.",
  ...
  "dialog.server.description": "Växla vilken NextCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar NextCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar NextCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera NextCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera NextCode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan NextCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "NextCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan NextCode igen.",
  ...
  "help.tabs.introduction": "NextCode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av NextCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till NextCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, NextCode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "NextCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör NextCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för NextCode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur NextCode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om NextCode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa NextCodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när NextCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av NextCode.",
