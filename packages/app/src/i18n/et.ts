...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.recovery.loadFailed": "NextCode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "NextCode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "NextCode ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "NextCode installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NextCode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub NextCode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid NextCode'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises NextCode.",
  ...
  "dialog.server.description": "Lülitage, millise NextCode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "NextCode kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "NextCode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "NextCode värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "NextCode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda NextCode jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige NextCode asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui NextCode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "NextCode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti NextCode.",
  ...
  "help.tabs.introduction": "NextCode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse NextCode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast NextCode meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, NextCode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "NextCode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "NextCode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage NextCode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke NextCode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas NextCode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas NextCode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas NextCode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui NextCode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse NextCode uusimat versiooni.",
