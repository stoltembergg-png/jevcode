export const dict = {
  ...
  "desktop.menu.documentation": "Documentație NextCode",
  ...
  "desktop.menu.ariaLabel": "Meniu NextCode",
  ...
  "desktop.recovery.loadFailed": "NextCode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra NextCode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "NextCode nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea NextCode a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea NextCode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de NextCode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în NextCode.",
  ...
  "dialog.server.description": "Schimbă serverul NextCode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică NextCode în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează NextCode în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează NextCode în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează NextCode în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca NextCode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "NextCode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune NextCode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei NextCode",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, NextCode nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "NextCode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul NextCode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru NextCode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul NextCode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă NextCode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema NextCode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea NextCode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune NextCode.",
