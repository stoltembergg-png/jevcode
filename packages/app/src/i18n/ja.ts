...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.recovery.loadFailed": "NextCodeを読み込めませんでした",
  "desktop.recovery.terminated": "NextCodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "NextCodeが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "NextCodeのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはNextCodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "NextCodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "NextCodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、NextCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してNextCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、NextCodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するNextCodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "NextCodeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のNextCodeを確認中...",
  "wsl.onboarding.updatingOpencode": "NextCodeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のNextCodeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のNextCodeを更新してください。",
  "wsl.onboarding.updateOpencode": "NextCodeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のNextCodeの準備ができました。",
  "wsl.onboarding.opencodeReady": "NextCodeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にNextCodeをインストールしてください。",
  "wsl.onboarding.installOpencode": "NextCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NextCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、NextCodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "NextCode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NextCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをNextCodeチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: NextCodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "NextCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でNextCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "NextCodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのNextCodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "NextCodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "NextCodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "NextCode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "NextCode は最新バージョンです。",
