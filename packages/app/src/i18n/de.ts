...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von NextCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in NextCode zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in NextCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in NextCode zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den NextCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "NextCode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "NextCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "NextCode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "NextCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie NextCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "NextCode aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "NextCode ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "NextCode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie NextCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "NextCode installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor NextCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "NextCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann NextCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von NextCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem NextCode-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: NextCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "NextCode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "NextCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "NextCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für NextCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie NextCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob NextCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von NextCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von NextCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "NextCode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von NextCode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "NextCode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das NextCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "NextCode reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "NextCode-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das NextCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "NextCode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
