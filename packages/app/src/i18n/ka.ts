...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "NextCode დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "NextCode მენიუ",
  ...
  "desktop.recovery.loadFailed": "NextCode ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "NextCode ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "NextCode არ პასუხობს",
  ...
  "desktop.wsl.error.installOpencode": "NextCode ინსტალაცია ვერ მოხერხდა",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NextCode განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია NextCode",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები NextCode-ში.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen გაძლევთ წვდომას კოდირების აგენტებისთვის საიმედო ოპტიმიზირებული მოდელების კურირებულ კომპლექტზე.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები NextCode-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები NextCode-ში.",
  ...
  "dialog.server.description": "გადართეთ რომელ NextCode სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingOpencode": "შემოწმებულია NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "შემოწმებულია NextCode-ში {{distro}}...",
  "wsl.onboarding.updatingOpencode": "განახლება NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "NextCode განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "განახლება NextCode {{distro}}-ში.",
  "wsl.onboarding.updateOpencode": "განახლება NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode მზად არის {{distro}}-ში.",
  "wsl.onboarding.opencodeReady": "NextCode მზად არის.",
  "wsl.onboarding.installOpencodeIn": "დააინსტალირეთ NextCode {{distro}}-ში.",
  "wsl.onboarding.installOpencode": "დააინსტალირეთ NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ NextCode შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "NextCode ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით NextCode.",
  ...
  "help.tabs.introduction": "NextCode სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NextCode-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა NextCode გუნდს",
  ...
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, NextCode ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "NextCode მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "NextCode სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით NextCode სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა NextCode",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება NextCode თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა NextCode სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის NextCode თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც NextCode გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ NextCode-ის უახლეს ვერსიას.",
