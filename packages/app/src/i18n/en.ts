...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by NextCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in NextCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "NextCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in NextCode.",
  ...
  "dialog.server.description": "Switch which NextCode server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking NextCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating NextCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update NextCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install NextCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before NextCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "NextCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of NextCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the NextCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, NextCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "NextCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the NextCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for NextCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how NextCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether NextCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how NextCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when NextCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of NextCode.",
