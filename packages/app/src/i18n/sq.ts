...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "Dokumentacioni NextCode",
  ...
  "desktop.menu.ariaLabel": "Menuja NextCode",
  ...
  "desktop.recovery.loadFailed": "NextCode nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja NextCode u mbyll papritur",
  "desktop.recovery.unresponsive": "NextCode nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i NextCode dështoi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i NextCode përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga NextCode",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në NextCode.",
  ...
  "dialog.server.description": "Ndrysho me cilin server NextCode lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon NextCode në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "NextCode po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson NextCode në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso NextCode në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni NextCode në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se NextCode të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "NextCode nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i NextCode ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i NextCode",
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, NextCode nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "NextCode përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin NextCode brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për NextCode",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket NextCode në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse NextCode ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e NextCode.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset NextCode",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të NextCode.",
