...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "Документація NextCode",
  ...
  "desktop.menu.ariaLabel": "Меню NextCode",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити NextCode",
  "desktop.recovery.terminated": "Роботу вікна NextCode несподівано завершено",
  "desktop.recovery.unresponsive": "NextCode не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити NextCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення NextCode завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від NextCode",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у NextCode.",
  ...
  "dialog.server.description": "Перемкніть сервер NextCode, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка NextCode у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення NextCode у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть NextCode у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть NextCode у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в NextCode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "NextCode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія NextCode ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді NextCode",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, NextCode ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "NextCode містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер NextCode всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу NextCode",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд NextCode на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи NextCode використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему NextCode.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску NextCode",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію NextCode.",
