export const dict = {
  "settings.general.section.storage": "Armazenamento",
  "settings.general.storage.database.title": "Tamanho do banco de dados",
  "settings.general.storage.database.description": "Espaço em disco usado pelo banco de dados do servidor",
  "settings.general.storage.tables.title": "Maiores tabelas",
  "settings.general.storage.tables.description": "Espaço usado por cada tabela no banco de dados",
  "settings.general.storage.compact.title": "Compactar banco de dados",
  "settings.general.storage.compact.description": "Remove dados não utilizados e recupera espaço em disco",
  "settings.general.storage.compact.action": "Compactar agora",
  "settings.general.storage.compact.running": "Compactando…",
  "settings.general.storage.compact.last": "Última compactação em {{date}}",
  "settings.general.storage.compact.never": "Nunca compactado",
  "settings.general.storage.compact.result": "O banco de dados agora tem {{size}}",
  "settings.general.storage.refresh": "Atualizar informações de armazenamento",
  ...
  "desktop.menu.documentation": "Documentação do NextCode",
  ...
  "desktop.menu.ariaLabel": "Menu do NextCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o NextCode",
  "desktop.recovery.terminated": "A janela do NextCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O NextCode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do NextCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O NextCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do NextCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo NextCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no NextCode.",
  ...
  "dialog.server.description": "Trocar para qual servidor NextCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o NextCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o NextCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o NextCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o NextCode",
  "wsl.onboarding.opencodeReadyIn": "O NextCode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O NextCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o NextCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o NextCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O NextCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o NextCode novamente.",
  ...
  "help.tabs.introduction": "Agora, o NextCode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do NextCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do NextCode",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: NextCode ainda não suporta autenticação MCP.',
  ...
  "semif.mode.auto": "Automático",
  "semif.mode.lazy": "Sob demanda",
  "semif.mode.off": "Desativado",
  "semif.description.auto": "Carrega o modelo local no início do NextCode",
  "semif.description.lazy": "Carrega o modelo na primeira decisão",
  "semif.description.off": "Plugin desativado",
  "semif.not_configured": "plugin semif não configurado neste projeto",
  ...
  "semif.state.unsupported": "Indisponível nesta plataforma",
  "semif.state.disabled": "O SemIf está desativado",
  "semif.action.start": "Preparar modelo",
  ...
  "sidebar.gettingStarted.line1": "NextCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "app.name.desktop": "NextCode Desktop",
  ...
  "settings.desktop.wsl.description": "Executar o servidor NextCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do NextCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o NextCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o NextCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o NextCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o NextCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do NextCode.",
