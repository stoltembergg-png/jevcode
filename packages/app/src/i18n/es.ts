export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de NextCode",
  ...
  "desktop.menu.ariaLabel": "Menú de NextCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar NextCode",
  "desktop.recovery.terminated": "La ventana de NextCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "NextCode no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar NextCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de NextCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por NextCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en NextCode.",
  ...
  "dialog.server.description": "Cambiar el servidor de NextCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando NextCode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando NextCode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza NextCode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala NextCode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que NextCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "NextCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de NextCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de NextCode",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: NextCode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "NextCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor NextCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para NextCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve NextCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si NextCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de NextCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia NextCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de NextCode.",
