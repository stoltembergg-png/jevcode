...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "NextCode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú NextCode.",
  ...
  "desktop.recovery.loadFailed": "NextCode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra NextCode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "NextCode no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de NextCode ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NextCode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per NextCode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a NextCode.",
  ...
  "dialog.server.description": "Canvia a quin NextCode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant NextCode a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant NextCode a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza NextCode a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu NextCode a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que NextCode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "NextCode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir NextCode.",
  ...
  "help.tabs.introduction": "NextCode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de NextCode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip NextCode.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que NextCode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "NextCode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "NextCode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor NextCode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a NextCode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu NextCode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si NextCode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de NextCode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï NextCode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de NextCode.",
