...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "NextCode Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka NextCode",
  ...
  "desktop.recovery.loadFailed": "NextCode se nepodařilo načíst",
  "desktop.recovery.terminated": "NextCode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "NextCode nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "NextCode instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NextCode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v NextCode.",
  ...
  "dialog.server.description": "Přepněte, ke kterému NextCode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola NextCode v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace NextCode v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace NextCode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte NextCode do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než NextCode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "NextCode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete NextCode.",
  ...
  "help.tabs.introduction": "NextCode Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze NextCode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu NextCode",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: NextCode zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "NextCode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server NextCode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro NextCode",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled NextCode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude NextCode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma NextCode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění NextCode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi NextCode.",
