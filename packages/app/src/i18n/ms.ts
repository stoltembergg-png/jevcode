...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "Dokumentasi NextCode",
  ...
  "desktop.recovery.loadFailed": "NextCode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap NextCode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "NextCode tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan NextCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini NextCode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh NextCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam NextCode.",
  ...
  "dialog.server.description": "Tukar pelayan NextCode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak NextCode dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini NextCode dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini NextCode dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang NextCode dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum NextCode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "NextCode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu NextCode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan NextCode",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, NextCode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "NextCode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan NextCode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk NextCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa NextCode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada NextCode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema NextCode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila NextCode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini NextCode.",
