export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja NextCode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać NextCode",
  "desktop.recovery.terminated": "Okno NextCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "NextCode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować NextCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja NextCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez NextCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w NextCode.",
  ...
  "dialog.server.description": "Przełącz serwer NextCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie NextCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie NextCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj NextCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj NextCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim NextCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "NextCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja NextCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu NextCode",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: NextCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "NextCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer NextCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla NextCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd NextCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy NextCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw NextCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania NextCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji NextCode.",
