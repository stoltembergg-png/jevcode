...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða NextCode",
  "NextCode-glugganum var óvænt lokað",
  "NextCode svarar ekki",
  ...
  "NextCode er ekki uppsett í {{distro}}",
  "Uppfærslu NextCode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá NextCode",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í NextCode.",
  ...
  "dialog.server.description": "Skiptu um hvaða NextCode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar NextCode í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir NextCode í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu NextCode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp NextCode í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en NextCode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "NextCode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan NextCode aftur.",
  ...
  "help.tabs.introduction": "NextCode Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af NextCode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til NextCode teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, NextCode styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "NextCode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "NextCode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu NextCode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir NextCode",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig NextCode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort NextCode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig NextCode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar NextCode ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af NextCode.",
