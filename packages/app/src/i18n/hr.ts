...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "NextCode se nije uspio učitati",
  "Prozor aplikacije NextCode neočekivano je zatvoren",
  "NextCode ne reagira",
  ...
  "Instalacija aplikacije NextCode nije uspjela",
  ...
  "NextCode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije NextCode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi NextCode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u NextCode.",
  ...
  "dialog.server.description": "Promijenite na koji se NextCode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera NextCode u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje NextCode u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte NextCode u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte NextCode u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte NextCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što NextCode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "NextCode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite NextCode.",
  ...
  "help.tabs.introduction": "Radna površina NextCode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija NextCode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku NextCode timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, NextCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "NextCode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "NextCode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite NextCode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za NextCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako NextCode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li NextCode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je NextCode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se NextCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju NextCode.",
