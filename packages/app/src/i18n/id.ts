export const dict = {
  ...
  "desktop.recovery.loadFailed": "NextCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela NextCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "NextCode tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi NextCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan NextCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh NextCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di NextCode.",
  ...
  "dialog.server.description": "Ganti server NextCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa NextCode di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui NextCode di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui NextCode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal NextCode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum NextCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "NextCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru NextCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim NextCode",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: NextCode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "NextCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server NextCode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk NextCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan NextCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah NextCode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat NextCode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru NextCode.",
