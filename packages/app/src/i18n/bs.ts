...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "Dokumentacija za NextCode",
  ...
  "desktop.menu.ariaLabel": "NextCode meni",
  ...
  "desktop.recovery.loadFailed": "NextCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor NextCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "NextCode ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija NextCode-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje NextCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje NextCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u NextCode-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u NextCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u NextCode-u.",
  ...
  "dialog.server.description": "Promijeni na koji se NextCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera NextCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje NextCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj NextCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj NextCode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi NextCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "NextCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija NextCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku NextCode timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: NextCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "NextCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni NextCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u NextCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako NextCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li NextCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu NextCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se NextCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju NextCode-a.",
