...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "NextCode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "NextCode menyusi",
  ...
  "desktop.recovery.loadFailed": "NextCode yuklanmadi",
  "desktop.recovery.terminated": "NextCode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "NextCode javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "NextCode oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "NextCode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "NextCode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va NextCode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va NextCode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va NextCode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi NextCode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "NextCode tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "NextCode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "NextCode yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "NextCode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "NextCode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "NextCode-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "NextCode {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "NextCode tayyor.",
  "wsl.onboarding.installOpencodeIn": "NextCode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "NextCode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NextCode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "NextCode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra NextCode-ni qayta oching.",
  ...
  "help.tabs.introduction": "NextCode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NextCode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida NextCode jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, NextCode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "NextCode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi NextCode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "NextCode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "NextCode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "NextCode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "NextCode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "NextCode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz NextCode oxirgi versiyasini ishga tushiryapsiz.",
