...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "NextCode įkelti nepavyko",
  "NextCode langas netikėtai užsidarė",
  "NextCode neatsako",
  ...
  "NextCode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "NextCode neįdiegtas distributyve {{distro}}",
  "NextCode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami NextCode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius NextCode.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio NextCode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama NextCode {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas NextCode {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite NextCode {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite NextCode į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad NextCode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "NextCode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują NextCode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą NextCode komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad NextCode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "NextCode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "NextCode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite NextCode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite NextCode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip NextCode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar NextCode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite NextCode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas NextCode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią NextCode versiją.",
