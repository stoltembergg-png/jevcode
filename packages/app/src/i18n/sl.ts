...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "NextCode Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "NextCode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno NextCode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "NextCode se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev NextCode ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev NextCode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja NextCode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v NextCode.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom NextCode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje NextCode ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje NextCode v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje NextCode ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje NextCode v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite NextCode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite NextCode v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite NextCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko NextCode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "NextCode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite NextCode.",
  ...
  "help.tabs.introduction": "NextCode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica NextCode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi NextCode",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, NextCode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "NextCode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik NextCode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za NextCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako NextCode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali NextCode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo NextCode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene NextCode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico NextCode.",
