...
"settings.general.storage.refresh": "Refresh storage information",
  ...
  "desktop.menu.documentation": "NextCode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "NextCode-meny",
  ...
  "desktop.recovery.loadFailed": "NextCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "NextCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "NextCode svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av NextCode mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NextCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av NextCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av NextCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i NextCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NextCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i NextCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i NextCode.",
  ...
  "dialog.server.description": "Bytt hvilken NextCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av NextCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til NextCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at NextCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "NextCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør NextCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for NextCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan NextCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om NextCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i NextCode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når NextCode starter",
  ...
  "settings.updates.toast.latest.title": "NextCode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av NextCode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker NextCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker NextCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer NextCode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer NextCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater NextCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater NextCode",
  "wsl.onboarding.opencodeReadyIn": "NextCode er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "NextCode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer NextCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NextCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før NextCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "NextCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter NextCode på nytt.",
  ...
  "help.tabs.introduction": "NextCode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
