export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የNextCode ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከNextCode ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
