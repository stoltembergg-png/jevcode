export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko NextCode versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "NextCode versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
