export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo NextCoden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "NextCoden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää NextCoden uudelleen?",
