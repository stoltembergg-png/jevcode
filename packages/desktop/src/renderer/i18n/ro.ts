export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} NextCode a fost descărcată. Vrei să o instalezi și să repornești?",
