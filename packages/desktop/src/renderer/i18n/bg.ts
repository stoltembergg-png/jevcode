export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от NextCode е изтеглена. Искате ли да я инсталирате и рестартирате?",
