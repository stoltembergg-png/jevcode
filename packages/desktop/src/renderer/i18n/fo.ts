export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av NextCode.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av NextCode er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
