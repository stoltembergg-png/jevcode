export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av NextCode har laddats ned. Vill du installera den och starta om programmet?",
