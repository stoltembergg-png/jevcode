export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van NextCode is gedownload. Wil je deze installeren en NextCode opnieuw starten?",
