export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von NextCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
