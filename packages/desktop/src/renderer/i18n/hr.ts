export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije NextCode. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
