export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} NextCode telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
