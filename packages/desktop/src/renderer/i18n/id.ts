export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "NextCode versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
