export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di NextCode è stata scaricata. Vuoi installarla e riavviare l'app?",
