export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse NextCode uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "NextCode'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
