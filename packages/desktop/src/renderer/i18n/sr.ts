export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од NextCode је преузета, да ли желите да је инсталирате и поново покренете?",
