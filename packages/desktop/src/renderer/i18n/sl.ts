export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} NextCode je bila prenesena, jo želite namestiti in znova zagnati?",
