export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av NextCode er lastet ned. Vil du installere den og starte på nytt?",
