export const dict = {
  ...
  "desktop.updater.none.message": "თქვენ უკვე იყენებთ NextCode-ის უახლეს ვერსიას",
  ...
  "desktop.updater.downloaded.prompt":
    "NextCode-ის {{version}} ვერსია ჩამოტვირთულია, გსურთ მისი ინსტალაცია და ხელახლა გაშვება?",
