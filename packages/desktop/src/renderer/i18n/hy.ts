export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք NextCode-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "NextCode-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
