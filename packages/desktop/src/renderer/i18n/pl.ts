export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} NextCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
