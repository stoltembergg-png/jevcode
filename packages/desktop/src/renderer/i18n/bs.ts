export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju NextCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} NextCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
