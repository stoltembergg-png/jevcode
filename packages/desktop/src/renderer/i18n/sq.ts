export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i NextCode është shkarkuar, dëshironi ta instaloni dhe rinisni?",
