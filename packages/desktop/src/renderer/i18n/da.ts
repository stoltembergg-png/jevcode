export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af NextCode er blevet downloadet. Vil du installere den og genstarte?",
