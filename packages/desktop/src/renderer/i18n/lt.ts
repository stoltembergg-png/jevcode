export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią NextCode versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "NextCode versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
