export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of NextCode has been downloaded, would you like to install it and relaunch?",
