export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi NextCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace NextCode. Chcete ji nainstalovat a aplikaci znovu spustit?",
