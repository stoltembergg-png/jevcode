export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Předplaťte si NextCode Go za 10 USD měsíčně a získejte spolehlivý přístup k nejlepším modelům s otevřeným zdrojovým kódem.",
  ...
  "ui.sessionTurn.thinking.decisions.one": "{{count}} rozhodnutí",
  "ui.sessionTurn.thinking.decisions.few": "{{count}} rozhodnutí",
  "ui.sessionTurn.thinking.decisions.many": "{{count}} rozhodnutí",
  "ui.sessionTurn.thinking.decisions.other": "{{count}} rozhodnutí",
  "ui.sessionTurn.thinking.tokens": "{{tokens}} tokenů",
