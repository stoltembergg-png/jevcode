...
export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "NextCode Go für 10 $ pro Monat abonnieren und zuverlässigen Zugriff auf die besten Open-Source-Modelle erhalten.",
  ...
  "ui.sessionTurn.thinking.decisions.one": "{{count}} Entscheidung",
  "ui.sessionTurn.thinking.decisions.other": "{{count}} Entscheidungen",
