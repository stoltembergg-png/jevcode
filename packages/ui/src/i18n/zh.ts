...
export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description": "每月 $10 订阅 NextCode Go，可靠地使用最佳开源模型。",
  ...
  "ui.sessionTurn.thinking.decisions.other": "{{count}} 个决策",
  "ui.sessionTurn.thinking.tokens": "{{tokens}} 个令牌",
