...
export const dict: Record<Keys, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Abonner på NextCode Go for $10/måned for pålitelig tilgang til de beste modellene med åpen kildekode.",
  ...
  "ui.sessionTurn.thinking.decisions.one": "{{count}} beslutning",
  "ui.sessionTurn.thinking.decisions.other": "{{count}} beslutninger",
  ...
  "ui.tool.shell": "Shell",
  "ui.tool.shell.action.search": "Søker i filer",
  "ui.tool.shell.action.list": "Viser filer",
  "ui.tool.shell.action.read": "Leser filer",
  "ui.tool.shell.action.test": "Kjører tester",
  "ui.tool.shell.action.build": "Bygger",
  "ui.tool.shell.action.git": "Kjører git {{verb}}",
  "ui.tool.shell.action.install": "Installerer avhengigheter",
  "ui.tool.shell.action.fetch": "Henter",
  "ui.tool.shell.action.command": "Kjører en kommando",
  "ui.tool.patch": "Patch",
