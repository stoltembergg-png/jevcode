export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Претплатите се на NextCode Go за 10 УСД месечно и остварите поуздан приступ најбољим моделима отвореног кода.",
  ...
  "ui.sessionTurn.thinking.decisions.one": "{{count}} одлука",
  "ui.sessionTurn.thinking.decisions.few": "{{count}} одлуке",
  "ui.sessionTurn.thinking.decisions.other": "{{count}} одлука",
