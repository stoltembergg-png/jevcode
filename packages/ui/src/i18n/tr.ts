...
export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "En iyi açık kaynaklı modellere güvenilir erişim için aylık $10 karşılığında NextCode Go'ya abone olun.",
  ...
  "ui.sessionTurn.thinking.decisions.one": "{{count}} karar",
  "ui.sessionTurn.thinking.decisions.other": "{{count}} karar",
