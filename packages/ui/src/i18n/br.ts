export const dict = {
  "ui.tool.shell.action.search": "Buscando em arquivos",
  "ui.tool.shell.action.list": "Listando arquivos",
  "ui.tool.shell.action.read": "Lendo arquivos",
  "ui.tool.shell.action.test": "Executando testes",
  "ui.tool.shell.action.build": "Compilando",
  "ui.tool.shell.action.git": "Executando git {{verb}}",
  "ui.tool.shell.action.install": "Instalando dependências",
  "ui.tool.shell.action.fetch": "Obtendo",
  "ui.tool.shell.action.command": "Executando um comando",
  ...
  "dialog.usageExceeded.freeTier.description":
    "Assine o NextCode Go por $10/mês para ter acesso confiável aos melhores modelos de código aberto.",
  ...
  "ui.sessionTurn.thinking.decisions.one": "{{count}} decisão",
  "ui.sessionTurn.thinking.decisions.many": "{{count}} decisões",
  "ui.sessionTurn.thinking.decisions.other": "{{count}} decisões",
  "ui.sessionTurn.thinking.tokens": "{{tokens}} tokens",
