export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Subscriviu-vos a NextCode Go per 10 dòlars al mes i obteniu accés fiable als millors models de codi obert.",
  ...
  "ui.sessionTurn.thinking.decisions.one": "{{count}} decisió",
  "ui.sessionTurn.thinking.decisions.many": "{{count}} decisions",
  "ui.sessionTurn.thinking.decisions.other": "{{count}} decisions",
