export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Abbonati a NextCode Go per 10 $ al mese e accedi in modo affidabile ai migliori modelli open source.",
  ...
  "ui.sessionTurn.thinking.decisions.one": "{{count}} decisione",
  "ui.sessionTurn.thinking.decisions.many": "{{count}} decisioni",
  "ui.sessionTurn.thinking.decisions.other": "{{count}} decisioni",
  "ui.sessionTurn.thinking.tokens": "{{tokens}} token",
