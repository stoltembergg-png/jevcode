export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "އެންމެ ރަނގަޅު އޮޕަން ސޯސް މޮޑެލްތަކަށް އިތުބާރުހުރި ގޮތެއްގައި އެކްސެސް ހޯދުމަށް މަހަކު 10 ޑޮލަރަށް NextCode Go އަށް ސަބްސްކްރައިބް ކޮށްލައްވާ.",
  ...
  "ui.sessionTurn.thinking.decisions.one": "{{count}} ޤާރަރު",
  "ui.sessionTurn.thinking.decisions.many": "{{count}} ޤާރަރުތައް",
  "ui.sessionTurn.thinking.decisions.other": "{{count}} ޤާރަރުތައް",
