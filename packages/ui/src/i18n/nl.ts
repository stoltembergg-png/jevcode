export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Abonneer je voor $ 10 per maand op NextCode Go voor betrouwbare toegang tot de beste open-sourcemodellen.",
  ...
  "ui.sessionTurn.thinking.decisions.one": "{{count}} beslissing",
  "ui.sessionTurn.thinking.decisions.other": "{{count}} beslissingen",
