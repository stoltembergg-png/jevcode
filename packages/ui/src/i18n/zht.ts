...
export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description": "每月 $10 訂閱 NextCode Go，可靠地使用最佳開源模型。",
  ...
  "ui.sessionTurn.thinking.decisions.other": "{{count}} 個決策",
  "ui.sessionTurn.thinking.tokens": "{{tokens}} 個令牌",
