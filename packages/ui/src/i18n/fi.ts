export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Tilaa NextCode Go 10 dollarilla kuukaudessa saadaksesi luotettavan pääsyn parhaisiin avoimen lähdekoodin malleihin.",
  ...
  "ui.sessionTurn.thinking.decisions.one": "{{count}} päätös",
  "ui.sessionTurn.thinking.decisions.other": "{{count}} päätöstä",
  "ui.sessionTurn.thinking.tokens": "{{tokens}} tokenia",
