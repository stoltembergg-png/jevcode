export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Abonează-te la NextCode Go pentru 10$/lună și obține acces fiabil la cele mai bune modele open-source.",
  ...
  "ui.sessionTurn.thinking.decisions.one": "{{count}} decizie",
  "ui.sessionTurn.thinking.decisions.few": "{{count}} decizii",
  "ui.sessionTurn.thinking.decisions.other": "{{count}} decizii",
