export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Prenumerera på NextCode Go för 10 USD/månad och få pålitlig tillgång till de bästa modellerna med öppen källkod.",
  ...
  "ui.sessionTurn.thinking.decisions.one": "{{count}} beslut",
  "ui.sessionTurn.thinking.decisions.other": "{{count}} beslut",
