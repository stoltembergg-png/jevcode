...
const docs = `### Overview
Line comment **display** and **editor** cards aligned with NextCode line-comment specs (raised \`#FAFAFA\` surface, footer line context, \`ButtonV2\` neutral + contrast actions).
