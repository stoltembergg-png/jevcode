...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[NextCode](https://github.com/stoltembergg-png/nextcode)")).toBe(
    '<p><a href="https://github.com/stoltembergg-png/nextcode" class="external-link" target="_blank" rel="noopener noreferrer">NextCode</a></p>\n',
  )
})
