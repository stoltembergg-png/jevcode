...
Use this folder for locale-specific translation guidance that supplements `.NextCode/agent/translator.md`.
...
- PR #12345: https://github.com/stoltembergg-png/nextcode/pull/12345

## Do Not Translate (Locale Additions)

- `NextCode` (preserve casing)
