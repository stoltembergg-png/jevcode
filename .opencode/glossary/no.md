...
- PR #10018: https://github.com/stoltembergg-png/nextcode/pull/10018
- PR #12935: https://github.com/stoltembergg-png/nextcode/pull/12935

## Do Not Translate (Locale Additions)

- `NextCode` (preserve casing in prose; keep `NextCode` only in commands, package names, paths, or code)
- `NextCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
