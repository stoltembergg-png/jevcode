...
- PR #13942: https://github.com/stoltembergg-png/nextcode/pull/13942

## Do Not Translate (Locale Additions)

- `NextCode` (preserve casing in prose; keep `NextCode` only when it is part of commands, package names, paths, or code)
- `OpenCode Zen`
- `NextCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `NextCode` in prose when referring to the product name; use `NextCode`
