...
- PR #15835: https://github.com/stoltembergg-png/nextcode/pull/15835

## Do Not Translate (Locale Additions)

- `NextCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `NextCode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `NextCode` in prose, `NextCode` only for exact technical identifiers
...
- Avoid changing `NextCode` to `NextCode` inside commands, URLs, package names, or code literals
